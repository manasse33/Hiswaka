...
import { 
  ...
  Activity, Download, X, FileText, Building, Mail, Calendar, AlertTriangle 
} from 'lucide-react';

// --- MOCK DATA (Graphiques) ---
const activityData = [
...
// --- DONNÉES FICTIVES (Demandes) ---
const initialRequests = [
    { id: 1, org: "OMS - Bureau Congo", type: "International", name: "Dr. Jean Malonga", email: "jean.m@oms.org", date: "06 Déc 2024", status: "PENDING", reason: "Accès aux micro-données de morbidité (Paludisme/Pool).", files: ["Lettre_Accreditation.pdf", "Passport_Scan.jpg"] },
    { id: 2, org: "Université Marien Ngouabi", type: "Recherche", name: "Prof. Sarah Nguesso", email: "s.nguesso@umng.cg", date: "07 Déc 2024", status: "PENDING", reason: "Étude doctorale : Impact inflation ménages ruraux.", files: ["Carte_Etudiant.pdf"] },
    { id: 3, org: "Banque Postale", type: "Privé", name: "Directeur Stratégie", email: "strat@banquepostale.cg", date: "05 Déc 2024", status: "REJECTED", reason: "Analyse marché immobilier.", files: ["Kbis.pdf"] },
];
